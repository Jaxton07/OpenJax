...
/// Calculates the minimal modifier transitions between two ratatui style modifier sets.
...
mod tests {
    ...
    use super::ModifierDiff;

    #[test]
    fn computes_removed_and_added_modifiers() {
        let diff = ModifierDiff {
            from: Modifier::BOLD | Modifier::UNDERLINED,
            to: Modifier::DIM,
        };
